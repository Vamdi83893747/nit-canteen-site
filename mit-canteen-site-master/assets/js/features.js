    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">NIT AP</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">NIT AP</span> <span class="clr-green md">Canteen</span></div>
        ...
        <form class="modal-form grid py-1 text-center" id="main-form" required>
            ...
            <button type="subNIT AP" class="btn">Register</button>
        </form>
                ...
                <main class="grid grid-3">
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-map-marker-alt"></i> <p>tadepalligudem Bypass Road,  (MP)-452016</p></li>
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://github.com/rvutd/mit-canteen-site" target="_blank">Git Repository</a></li>
                            <li><a href=" https://www.nitandhra.ac.in/main/" target="_blank">
                            </a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
